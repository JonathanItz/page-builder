...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
              ...
              <div class="grid grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
                <div class="px-6 lg:px-0 lg:pr-4 lg:pt-4">
                  <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg">
                    ...
                    <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Control your site</p>
                    <p class="mt-6 text-lg leading-8 text-gray-600">
                        Easily manage every aspect of your website. From adjusting layouts to updating content, our easy-to-use tools put you in complete control. With Igloo Pages, managing your online presence has never been simpler.
                    </p>
                ...
                <div class="sm:px-6 lg:px-0">
                  <div class="relative isolate overflow-hidden bg-cyan-500 px-6 pt-8 sm:mx-auto sm:max-w-2xl sm:rounded-3xl sm:pl-16 sm:pr-0 sm:pt-16 lg:mx-0 lg:max-w-none">
                    ...
                    <div class="mx-auto max-w-2xl sm:mx-0 sm:max-w-none">
                      <img src="{{asset('/assets/images/homepage/dashboard.png')}}" alt="Product screenshot" width="2432" height="1442" class="-mb-12 w-[57rem] max-w-none rounded-tl-xl bg-gray-800 ring-1 ring-white/10">
                    </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8 py-24">
            <div class="gap-8 max-w-full grid md:grid-cols-12">
                <div class="mx-auto lg:mx-0 col-span-5">
                    {{-- <h2 class="text-base font-semibold leading-7 text-cyan-600">Pick your own design</h2> --}}
                    <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Flexible Sections</p>
                    <p class="mt-6 text-lg leading-8 text-gray-600">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8 py-24">
            <div class="gap-8 max-w-full grid md:grid-cols-12">
                <div class="mx-auto lg:mx-0 col-span-5">
                    ...
                    <p class="mt-6 text-lg leading-8 text-gray-600">
                        Design your perfect webpage effortlessly with Igloo Pages. Our minimalist design and user-friendly interface make building your site a easy. Simply select a design that complements your brand and start creating today!
                    </p>
                </div>

                <div class="col-span-7">
                    <img
                    src="{{asset('/assets/images/homepage/featured.png')}}"
                    alt="Product screenshot" class="rounded-3xl w-full max-w-full bg-gray-800 ring-1 ring-white/10 shadow-xl">
                </div>
            </div>
        </div>
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
              ...
              <div class="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                <div class="p-8 sm:p-10 lg:flex-auto">
                  ...
                  <p class="mt-6 text-base leading-7 text-gray-600">Build dynamic pages to display exactly what you want. Highlight your brand, set up waitlist pages, or design forms to gather leads effortlessly.</p>
        ...
        <footer class="bg-gray-100 py-3">
            <div class="mx-auto max-w-7xl px-4 text-center text-xs font-semibold">
                &copy; {{date('Y')}} |  <a href="/">Igloo Pages</a>
            </div>
        </footer>
